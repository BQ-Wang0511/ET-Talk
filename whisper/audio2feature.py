...
class Audio2Feature():
    ...
    def get_sliced_feature(self,
        ...
        if self.whisper_model_type == "large-v3":
            selected_feature = selected_feature.reshape(-1, 1280)# 50*384
        else:
    ...
    def audio2feat(self,audio_path):
        ...
        for emb in result['segments']:
            ...
            #print("encoder_embeddings shape:",encoder_embeddings[:emb_end_idx].shape)
            embed_list.append(encoder_embeddings[:emb_end_idx])
        concatenated_array = np.concatenate(embed_list, axis=0)
        return concatenated_array

if __name__ == "__main__":
    audio_processor = Audio2Feature(model_path="./models/whisper/large-v3.pt")
    audio_path = "./data/audio/liuwei_30s.mp3"
